...
public class Bus_stop {
    ...
    public Bus_stop(Integer bus_stop_id, String bus_stop_name, String latitude, String longitude) {
    ...
    public Integer getBus_stop_id() {
        return bus_stop_id;
    }

    public void setBus_stop_id(Integer bus_stop_id) {
        this.bus_stop_id = bus_stop_id;
    }
